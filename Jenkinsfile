pipeline {                                                                                                                    
    ...
    environment {
        ...
        NEXUS_PROTOCOL = 'http'
        NEXUS_URL = '16.171.165.6:8081' // Update with your actual Nexus IP
    ...
    steps {
        ...
        dependencyCheck(
            ...
            additionalArguments: '--scan . --format ALL --nvdApiDelay 8000'
        )
        //}
    }
    post {
            ...
            steps {
                ...
                script {
                    ...
                    def exitCode = sh(script: '''
                        ...
                        -t http://http://16.171.165.6:8081/dashboard \
